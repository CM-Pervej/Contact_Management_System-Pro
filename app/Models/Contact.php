    ...
    class Contact extends Model {
        ...
        public function create ($data) {
            ...
            $query = "INSERT INTO {$this->table} 
                (user_id, first_name, middle_name, last_name, nickname, phonetic_first, phonetic_last,name_suffix, name_prefix, company, department, title, notes, relation)
                VALUES 
                ('$user_id', '$first', '$middle', '$last', '$nickname', '$phonetic_first', '$phonetic_last', '$suffix', '$prefix', '$company', '$department', '$title', '$notes', '$relation')";
